...
' </Batch>
  ...
  ValueVar = "Test Company 1234"

  Dim strBatchXml As String
  strBatchXml = "<Batch OnError='Continue'><Method ID='1' Cmd='New'><Field Name='ID'>New</Field><Field Name='" + _
  FieldNameVar + "'>" + _
